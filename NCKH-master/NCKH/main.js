document.addEventListener("DOMContentLoaded", () => {
    ...
    function createSubNavigationWrrapperHotel() {
        if (!navigationWrapper.contains(document.querySelector(".place-nav-footer"))) {
            ...
            placeFooter.style.padding = "16px";
            placeFooter.style.border = "1px solid #e0e0e0";
            placeFooter.style.borderRadius = "12px";
            placeFooter.style.background = "#fff";
            placeFooter.style.boxShadow = "0 2px 6px rgba(0,0,0,0.1)";
            placeFooter.style.justifyContent = "space-between";
            placeFooter.style.alignItems = "center";
